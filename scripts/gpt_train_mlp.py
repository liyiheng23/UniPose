...
from scripts.gpt_train import SaveCallback, DataArguments, CustomTrainingArguments
...
def find_all_linear_names(model, train_hmr_backbone=False, train_llm=False):
    ...
    multimodal_keywords = ['mm_projector', 'vision_tower', 'vision_resampler', 'lm_head', 'pose_vqvae', 'smpl_decoder']
...
def train(attn_implementation=None):
    ...
    if train_llm:
        for n, p in model.named_parameters():
            if any([x in n for x in ["lm_head", 'embed_tokens', 'smpl_decoder']]):
