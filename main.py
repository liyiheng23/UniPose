...
gt_bboxes_3d = torch.load('gt_bboxes_3d.pt')
voxel_size = [0.1, 0.1]
out_size_factor = 8
heatmap = gt_bboxes_3d.new_zeros(10, 135, 135)
gt_labels_3d = torch.load('gt_labels_3d.pt')
...
import time; torch.cuda.synchronize(); t = time.perf_counter()
for idx in range(len(gt_bboxes_3d)):
    ...
    if width > 0 and length > 0:
        ...
        coor_x = ((x + 54) / voxel_size[0]/ 8)
        coor_y = ((y + 54) / voxel_size[1]/ 8)
