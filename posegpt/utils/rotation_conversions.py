...
def rot_convert(data, source='rotmat', target='axis_angle'):
    if source == 'rotmat' and target == 'axis_angle':
        return matrix_to_axis_angle(data)
    elif source == 'rotmat' and target == 'rot6d':
        return matrix_to_rotation_6d(data)
    else:
