...
from .config_utils import (
    LazyAttr, LazyObject, _is_builtin_module, ConfigParsingError, ImportTransformer, RemoveAssignFromAST, 
    check_file_exist, digit_version, get_installed_path, import_modules_from_strings,
    _lazy2string, _gather_abs_import_lazyobj, 
)
    ...
    def _substitute_env_variables(filename: str, temp_config_name: str):
        ...
        for var_name, value in keys:
            ...
            if var_name in os.environ:
                ...
                print(f'Using env variable `{var_name}` with value of '
